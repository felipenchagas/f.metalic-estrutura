...
export default async function SitemapsPage() {
    ...
    const sitemapData = [
        { name: 'sitemap.xml', type: 'Index Mestre', pages: '4 Sitemaps', url: '/sitemap.xml' },
        { name: 'sitemap-parana.xml', type: 'Silo Estadual', pages: `${citiesPR.length} Sitemaps`, url: '/sitemap-parana.xml' },
    ...
    citiesPR.forEach((c) => {
        ...
        const count = 1 + (cData?.neighborhoods?.length || 0)
                ...
                <table className="w-full text-left text-sm text-white/60">
                    <thead className="text-[10px] font-black uppercase tracking-widest text-[#C0392B] bg-black/50 border-b border-white/5">
                        <tr>
                            ...
                            <th className="px-6 py-4">Status de Geração</th>
