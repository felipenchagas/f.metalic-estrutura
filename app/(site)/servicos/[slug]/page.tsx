...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: `${siteConfig.url}/servicos/${slug}`,
            languages: {
                'pt-BR': `${siteConfig.url}/servicos/${slug}`
            }
        },
        openGraph: {
...
export default async function ServicePage({ params }: Props) {
    ...
    const schemaBreadcrumb = getBreadcrumbSchema([
        ...
        { name: service.shortTitle, url: `/servicos/${slug}` }
    ])
    ...
    return (
        <>
            ...
            <SEOInternalLinks currentContext="service" />
            <CTABand />
        </>
    )
}
